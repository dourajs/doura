import douraPkg from 'doura/package.json'
...
export default function Layout({ children }: { children: any }) {
  return (
    <div className="App">
      <header>
        <h1>Doura</h1>
        <h2>The intuitive store to manage state</h2>
      </header>
      ...
      <footer>
        <a href="https://github.com/dourajs/doura" target="_blank">
          <svg
            className="logo"
            viewBox="0 0 14 14"
            fill="none"
        ...
        - by
        <a href="https://github.com/liximomo" target="_blank">
          @liximomo
        </a>{' '}
        2022
        <br />
        Using Doura v{douraPkg.version}.
      </footer>
    </div>
  )
}
