  ...
  libs: [
    {
      ...
      fn: `create(baseState, (draft) => { draft.values().next().value.value = i });`,
    },
    {
      name: 'Immer',
      setup: `
        ...
        enableMapSet();
      `,
      fn: `produce(baseState, (draft) => { draft.values().next().value.value = i });`,
    },
    {
      name: 'Doura',
      setup: `
      ...
      `,
      fn: `douraProduce(baseState, (draft) => { draft.values().next().value.value = i });`,
    },
  ],
})
